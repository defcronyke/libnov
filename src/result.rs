...
*/
pub type NovResult = Result<NovResultSuccess, NovResultError>;
pub type NovResultSuccess = ();
pub type NovResultError = (NovResultErrorMsg, NovResultErrorCode);
pub type NovResultErrorMsg = String;
pub type NovResultErrorCode = i32;
